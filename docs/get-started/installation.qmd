...
hybrid-bias-correction/
  ...
  notebooks/              # Jupyter notebooks (nb00-nb07)
...
The full-Indonesia inputs and outputs are not committed to the repository. They live on Zenodo at [zenodo.org/records/20287847](https://zenodo.org/records/20287847) - download the bundle, extract, and point `config.yml` at the extracted directories to reproduce the Indonesia results.
