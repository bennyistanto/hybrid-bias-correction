...
The input is the gauge network (left); the output is a smooth confidence field that is high over Java and the denser clusters and near-zero over the sparsely gauged east:

![Left: the BMKG / CPC gauge network (Java-heavy, sparse east). Right: the resulting station-density confidence field. Demonstration on the Indonesia run.](../images/methodology/density_maps.png){#fig-density-maps fig-align="center"}
