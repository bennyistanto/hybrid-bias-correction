...
%  Remote Sensing — MDPI journal template (ACS numbered citations)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\authorcontributions{Conceptualization, B.I. and R.B.; methodology, B.I.; software, B.I.; validation, B.I.; formal analysis, B.I.; investigation, B.I.; resources, R.B. and I.P.S.; data curation, B.I.; writing---original draft preparation, B.I.; writing---review and editing, R.B. and I.P.S.; visualization, B.I.; supervision, R.B. and I.P.S. All authors have read and agreed to the published version of the manuscript.}
...
\dataavailability{The IMERG precipitation data are available from the NASA GES DISC (\url{https://disc.gsfc.nasa.gov/}). The CPC Unified Gauge-Based Analysis is available from the NOAA Physical Sciences Laboratory (\url{https://psl.noaa.gov/}). BMKG station data are available from the BMKG online data repository (\url{https://dataonline.bmkg.go.id/}).}

\acknowledgments{The authors acknowledge NASA for providing IMERG data, NOAA for CPC-UNI data, and BMKG for independent station observations used in validation.}
...
BSQS & Basic Statistical Quality Score\\
CDF & Cumulative Distribution Function\\
CNN & Convolutional Neural Network\\
CPC-UNI & CPC Unified Gauge-Based Analysis of Daily Precipitation\\
CQI & Continuous Quality Index\\
CSI & Critical Success Index\\
DL & Deep Learning\\
DQS & Distribution Quality Score\\
DSL & Dry Spell Length\\
EQM & Empirical Quantile Mapping\\
ETS & Equitable Threat Score\\
FAR & False Alarm Ratio\\
FPD & Frequency of Precipitation Days\\
GPD & Generalized Pareto Distribution\\
GPM & Global Precipitation Measurement\\
IMERG & Integrated Multi-satellitE Retrievals for GPM\\
IMERG-F & IMERG Final Run\\
IMERG-L & IMERG Late Run\\
KS & Kolmogorov-Smirnov\\
LS & Linear Scaling\\
LSEQM & Linear Scaling + EQM + GPD\\
LSEQM+DL & LSEQM + Deep Learning refinement\\
MAE & Mean Absolute Error\\
MDWP & Mean Wet-Day Precipitation\\
